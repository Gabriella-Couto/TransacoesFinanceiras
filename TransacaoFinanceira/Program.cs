    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            var TRANSACOES = new List<Transacao> {
                                     new Transacao(1, 938485762, unchecked((int)2147483649), 150),
                                     new Transacao (2, unchecked((int)2147483649), 210385733, 149),
                                     ...
                                     new Transacao(7, 938485762, unchecked((int)2147483649), 44),
